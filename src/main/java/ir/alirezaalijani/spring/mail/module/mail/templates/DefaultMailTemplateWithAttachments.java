...
public class DefaultMailTemplateWithAttachments extends HtmlMailWithAttachments {
    ...
    public DefaultMailTemplateWithAttachments(String toMail, String fromMail,
